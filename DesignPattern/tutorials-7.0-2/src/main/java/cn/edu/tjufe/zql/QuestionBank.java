...
import cn.edu.tjufe.zql.util.Topic;
import cn.edu.tjufe.zql.util.TopicRandomUtil;
...
public class QuestionBank implements Cloneable{
    ...
    public Object clone() throws CloneNotSupportedException{
        ...
        for(ChoiceQuestion choiceQuestion : choiceQuestionList ){
            Topic topic = TopicRandomUtil.random(choiceQuestion.getOptions(),choiceQuestion.getKey());
            choiceQuestion.setOptions(topic.getOptions());
